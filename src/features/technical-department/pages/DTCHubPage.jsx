...
import MeusDtcPage from "./MeusDtcPage";
  ...
  const Placeholder = ({ title }) => (
    <div className="p-4">
      <Alert variant="info">
        ...
        <p>
          A área de <strong>{title}</strong> do departamento técnico está sendo
          construída e será disponibilizada em breve.
        </p>
      </Alert>
    </div>
  );
  ...
  return (
    <div className="container-main p-4">
      <div className="page-header-colored mb-4">
        <div className="page-header-title-wrapper">
          ...
          <p className="page-header-subtitle">
            Central de ferramentas, projetos e conhecimento técnico.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <Tab eventKey="meus-projetos" title="Meus Projetos (Colaborador)">
          <MeusDtcPage />
        </Tab>
        <Tab
          eventKey="gerentes-produtos"
          title={
            <>
        ...
        >
          <div className="p-1">
            <OrganogramaTecnicoPage />
          </div>
        </Tab>
        <Tab
          eventKey="fabricantes"
          title={
            <>
