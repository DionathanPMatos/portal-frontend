...
const DashboardDTCPage = () => { // Renomeado
    ...
    const fetchData = async () => {
        try {
            ...
            const [projetosRes, tecnicosDtcRes, tecnicosTecnicoRes] = await Promise.all([ // Mantido
                apiClient.get('/api/projetos/dtc'),
                apiClient.get('/api/funcionarios', { params: { setorId: 3 } }), // Setor DTC
                apiClient.get('/api/funcionarios', { params: { setorId: 3 } })  // Setor Técnico
            ]);
